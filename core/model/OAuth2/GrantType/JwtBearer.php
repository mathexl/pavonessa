 ...
 *
 * @see https://tools.ietf.org/html/draft-ietf-oauth-jwt-bearer-04#section-4
 *
 * @author F21
...
class JwtBearer implements GrantTypeInterface, ClientAssertionTypeInterface
{
    ...
    public function validateRequest(RequestInterface $request, ResponseInterface $response)
    {
        ...
        // Check the jti (nonce)
        // @see https://tools.ietf.org/html/draft-ietf-oauth-json-web-token-13#section-4.1.7
        if (isset($jwt['jti'])) {
        ...
        // @see https://tools.ietf.org/html/draft-ietf-oauth-json-web-token-06#section-4.1.1
